...
public class HttpRetrieveHandler<TEntity>(ICorrelation correlation, IHttpClientFactory factory, IModelMetaService meta) : BaseHttpHandler<RetrieveEntityRequest<TEntity>, TEntity>(correlation, factory, meta) where TEntity : class, IModel
{
