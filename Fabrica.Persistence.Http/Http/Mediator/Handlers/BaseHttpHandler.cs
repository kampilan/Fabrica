...
public abstract class BaseHttpHandler<TRequest, TResponse>(ICorrelation correlation, IHttpClientFactory factory, IModelMetaService meta) : AbstractRequestHandler<TRequest, TResponse>(correlation) where TRequest : class, IRequest<Response<TResponse>>
{

    protected IHttpClientFactory Factory { get; } = factory;
    protected IModelMetaService Meta { get; } = meta;
