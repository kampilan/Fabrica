...
public static class OutboundEmailExtensions
{
    ...
    public static OutboundEmail AddTo(this OutboundEmail model, string address, string name = "")
    {
    ...
    public static OutboundEmail AddCc(this OutboundEmail model, string address, string name = "")
    {
    ...
    public static OutboundEmail AddBcc( this OutboundEmail model, string address, string name = "" )
    {
    ...
    public static OutboundEmail WithFrom(this OutboundEmail model, string address )
    {
    ...
    public static OutboundEmail WithReplyTo(this OutboundEmail model, string address )
    {

        model.ReplyToAddress = address;
    ...
    public static OutboundEmail AddAttachment(this OutboundEmail model, string fileName, string location )
    {
...
public class OutboundEmail
{
    ...
    public JObject Model { get; set; } = new ();
