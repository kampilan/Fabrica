...
public abstract class AbstractSearchProvider<TIndex> : CorrelatedObject, ISearchProvider<TIndex>, IRequiresStart, IDisposable where TIndex : class
{
    ...
    protected abstract Task<IEnumerable<InputDocument>> GetInputs();
