...
namespace Fabrica.Static.Appliance
{
    ...
    public class TheBootstrap: BaseBootstrap, IAwsCredentialModule, IFixedPackageMonitorModule, IMongoDbMonitorModule, IDynamoDbMonitorModule
    {
        ...
        public override void ConfigureWebApp( WebApplication builder)
        {
            ...
            var scope = builder.Services.GetAutofacRoot();
